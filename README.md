...
Calculate the estimated regression coefficients <img src="https://latex.codecogs.com/svg.image?\widehat{\beta}" title="https://latex.codecogs.com/svg.image?\widehat{\beta}" /> using one of methods solving by APGD or CVX for a given set of $\alpha_0$ and $\lambda_0$.
