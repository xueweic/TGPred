...
Calculate the estimated regression coefficients https://latex.codecogs.com/svg.image?\widehat{\beta&space;} using one of methods solving by APGD or CVX for a given set of $\alpha_0$ and $\lambda_0$.
