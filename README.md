...
Calculate the estimated regression coefficients ![](http://latex.codecogs.com/svg.latex?\hat{\beta}) using one of methods solving by APGD or CVX for a given set of $\alpha_0$ and $\lambda_0$.
